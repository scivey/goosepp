...
An MIT-licensed c++ port of [python-goose](https://github.com/grangier/python-goose), which is itself a port of the [original Scala Goose project](https://github.com/GravityLabs/goose).
